  ...
  render() {
    ...
    return (
      ...
      >
		...
		.signature-text{
			opacity: 0;
			-webkit-animation: fadein 2s linear forwards 3s;
			-o-animation: fadein 2s linear forwards 3s;
			-moz-animation: fadein 2s linear forwards 3s;
			animation: fadein 2s linear forwards 3s;
			font-family: 'Google Sans Medium', 'Inter', sans-serif;
			font-weight: 500;
		}
