...
export default class AiDeepLearningImg extends Component {
  render() {
    const theme = this.props.theme;
    return (
      <svg
        id="ai-deep-learning-svg"
        data-name="Layer 1"
      ...
      >
        {/* Updated metadata title for your specific focus section */}
        <title>Artificial Intelligence &amp; Deep Learning Illustration</title>
